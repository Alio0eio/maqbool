          ...
          notifications.map((notification) => {
            ...
            return (
              <ViewfinderCard
                ...
                className={cn("cursor-pointer", !notification.read && "ring-1 ring-primary/20")}
                  ...
                  <div className="flex items-start gap-4 min-w-0 flex-1">
                    ...
                    <div className="min-w-0">
                      <div className="flex items-center gap-2">
                        <h2 className="text-[15px] font-semibold text-foreground tracking-[-0.01em]">{notification.title}</h2>
