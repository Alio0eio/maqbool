    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="space-y-4">
          <ViewfinderCard>
            <CardContent className="p-5">
              <div className="flex items-center gap-1.5 mb-4"><AITag /><span className="font-semibold text-[13.5px]">AI Overall Score</span></div>
              <div className="flex items-center justify-center py-4">
                <MatchScoreBadge score={interview.application?.aiScore ?? 87} size="lg" />
              </div>
              <div className="text-center mt-2">
                <span className="text-[13.5px] font-semibold text-success">Recommended: Hire</span>
              </div>
            </CardContent>
          </ViewfinderCard>
          ...
          <ViewfinderCard>
            <CardContent className="p-5">
              <h3 className="text-[15px] font-semibold text-foreground tracking-[-0.01em] mb-4">Criteria Breakdown</h3>
          ...
          <ViewfinderCard>
            <CardContent className="p-5">
              <h3 className="text-[15px] font-semibold text-foreground tracking-[-0.01em] mb-3">Actions</h3>
        ...
        <div className="lg:col-span-2 space-y-4">
          ...
          <ViewfinderCard viewfinder className="overflow-hidden">
            <CardHeader className="flex flex-row items-center gap-3 border-b border-border/60 bg-surface-subtle/50 py-4">
              <Avatar className="w-10 h-10 border border-border/70 shrink-0">
              ...
              <div className="min-w-0">
                <CardTitle className="text-[15px]">Recorded Responses</CardTitle>
          ...
          <ViewfinderCard>
            <CardContent className="p-5">
              <div className="flex items-center gap-1.5 mb-3"><AITag /><span className="font-semibold text-[13.5px]">AI-Generated Summary</span></div>
              ...
              <div className="mt-4 grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  <div className="flex items-center gap-1.5 mb-2">
                    ...
                    <span className="text-[12.5px] font-semibold text-foreground">Strengths</span>
                  </div>
                ...
                <div>
                  <div className="flex items-center gap-1.5 mb-2">
                    ...
                    <span className="text-[12.5px] font-semibold text-foreground">Considerations</span>
                  </div>
                  {['Limited direct B2B enterprise exposure', 'May need onboarding to internal tools'].map(c => (
                    <div key={c} className="flex items-start gap-1.5 mb-1">
                      ...
                      <span className="text-[12.5px] text-muted-foreground">{c}</span>
                    </div>
                  ))}
                </div>
              </div>
          ...
          <ViewfinderCard>
            <CardContent className="p-5">
              <h3 className="text-[15px] font-semibold text-foreground tracking-[-0.01em] mb-4">Response Analysis by Question</h3>
              <div className="space-y-5">
                {reviewedQuestions.map((q, i) => (
                  <div key={q.id} className="border-b border-border/60 pb-5 last:border-0 last:pb-0">
                    <div className="flex items-start gap-2 mb-2">
                      <span className="w-5 h-5 bg-primary/10 text-primary rounded-full flex items-center justify-center text-xs font-semibold shrink-0">{i + 1}</span>
                    ...
                    <div className="ml-7 space-y-2">
                      ...
                      <div className="flex items-center gap-2 flex-wrap">
                        ...
                        <span className="text-[12.5px] font-semibold text-success">{90 - i * 4}%</span>
                        <span className="text-[12.5px] text-muted-foreground">· <span className="font-mono">{Math.floor(q.timeLimit / 60)}:{(q.timeLimit % 60).toString().padStart(2, '0')}</span> limit</span>
                      </div>
                    </div>
                  </div>
                ))}
