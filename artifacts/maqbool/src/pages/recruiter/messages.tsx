                  ...
                  <div className="flex items-start gap-4 min-w-0 flex-1">
                    ...
                    <div className="min-w-0">
                      <div className="flex items-center gap-2">
                        <h2 className="text-[15px] font-semibold text-foreground tracking-[-0.01em] truncate">{other.name}</h2>
                        {!!conversation.unreadCount && <Badge variant="destructive" className="shrink-0">New</Badge>}
                      </div>
                      <p className="text-[13.5px] text-muted-foreground mt-1 line-clamp-1">{conversation.lastMessage?.content}</p>
                      {conversation.relatedJobTitle && (
                        <p className="text-[12px] text-muted-foreground mt-1">Re: {conversation.relatedJobTitle}</p>
                      )}
                    </div>
                  </div>
