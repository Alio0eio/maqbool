  ...
  return (
    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
      <PageHeader
        ...
        actions={
          <Button className="shadow-sm" onClick={requestAvailability}>Request availability</Button>
        }
      />
          ...
          interviews.map(({ interview, job }) => (
            <ViewfinderCard key={interview.id} className="border-border shadow-sm">
              <CardHeader className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 p-6">
                <div>
                  <CardTitle className="text-lg font-display">{job?.title ?? "Upcoming interview"}</CardTitle>
              ...
              <CardContent className="grid grid-cols-1 md:grid-cols-3 gap-4 p-6 pt-0">
                <div className="bg-surface-subtle rounded-xl p-4">
                  ...
                  <div className="mt-3 text-sm text-foreground font-mono">
                ...
                <div className="bg-surface-subtle rounded-xl p-4">
                  ...
                  <div className="mt-3 text-sm text-foreground font-mono">{interview.duration ?? 30} mins</div>
                </div>
