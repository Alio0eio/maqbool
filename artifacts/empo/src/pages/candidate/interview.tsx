    ...
    return (
      <div className="max-w-2xl mx-auto py-16 animate-in fade-in duration-500">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-display font-bold text-foreground mb-2">Let's check your setup</h1>
        ...
        <Card className="border-border shadow-sm mb-6">
          <CardContent className="p-6 space-y-4">
            <button
              ...
              className={`w-full flex items-center justify-between p-4 rounded-lg border transition-all ${cameraChecked ? 'border-success bg-success/5' : 'border-border hover:border-primary/40'}`}
            >
            ...
            <button
              ...
              className={`w-full flex items-center justify-between p-4 rounded-lg border transition-all ${micChecked ? 'border-success bg-success/5' : 'border-border hover:border-primary/40'}`}
            >
              <div className="flex items-center gap-3">
        ...
        <div className="bg-surface-subtle rounded-lg p-4 text-sm text-muted-foreground border border-border mb-6">
  ...
  if (phase === "submitting") {
    return (
      <div className="max-w-2xl mx-auto py-20 text-center animate-in zoom-in duration-500">
        ...
        <h1 className="text-2xl font-display font-bold text-foreground mb-4">Submitting Interview</h1>
  ...
  if (phase === "complete") {
    return (
      <div className="max-w-2xl mx-auto py-20 text-center animate-in zoom-in duration-500">
        ...
        <h1 className="text-2xl font-display font-bold text-foreground mb-3">Interview Complete!</h1>
        ...
        <div className="flex flex-col gap-6">
          <Card className="border-border shadow-sm flex-1">
            <CardContent className="p-6 h-full flex flex-col">
              ...
              <div className="mt-auto bg-surface-subtle rounded-lg p-4 text-sm text-muted-foreground border border-border">
                <div className="flex items-start gap-3">
                  <AlertCircle className="w-5 h-5 text-primary shrink-0" />
                  <div>
